...
const { JWT_TOKEN, HASH_SECRET } = process.env
...
router.post('/register', upload.fields([{ name: 'documentFront' }, { name: 'documentBack' }]), async(req, res) => {
    ...
    try{
        ...
        await smtp.SEND(String(email), 'Cadastro em análise', 'waiting', context);
...
router.post('/approve/:id', async(req, res) => {
    ...
    try{
        ...
        await smtp.SEND(String(mail), 'Cadastro aprovado', 'approved', context);
...
router.post('/reject/:id', async(req, res) => {
    ...
    try{
        ...
        await smtp.SEND(String(mail), 'Cadastro em rejeitado', 'rejected', context);
